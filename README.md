...
This AI will take a corpus of documents and a query given by the user. It will determine the documents and sentences most relevant to the query.
...
## Background
Question Answering QA is a field within natural language processing focused on designing systems that can answer questions. Among the more famous question answering systems is Watson, the IBM computer that competed and won on Jeopardy!
